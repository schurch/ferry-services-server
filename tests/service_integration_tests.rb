...
RSpec.describe Service do
    ...
    it "saves information to the database" do
        service = Service.new(1, Time.utc(2015, 04, 06, 17, 40), 2, 'Arran', 'Ardrossan - Brodick', 2)
        service.additional_info = '<p>A1 road closed</p>'
        service.disruption_reason = 'weather'
        service.disruption_date = Time.utc(2015, 04, 03, 04, 20)
        ...
        expect(db_service['updated']).to be == Time.utc(2015, 04, 06, 17, 40).to_i
        ...
        expect(db_service['disruption_date']).to be == Time.utc(2015, 04, 03, 04, 20).to_i
    ...
    it "updates a service in the database" do
      ...
      service.updated = Time.utc(2015, 02, 04, 22, 23)
      ...
      service.disruption_date = Time.utc(2015, 02, 06, 02, 45)
      ...
      expect(db_service['service_id']).to be == 1
      expect(db_service['updated']).to be == Time.utc(2015, 02, 04, 22, 23).to_i
      ...
      expect(db_service['disruption_date']).to be == Time.utc(2015, 02, 06, 02, 45).to_i
    ...
    it "returns a service for id" do
      ...
      service1 = Service.new(3, time_now, 2, 'Arran', 'Ardrossan - Brodick', Service::NORMAL_SERVICE)
      service1.additional_info = '<p>A1 road closed</p>'
      service1.disruption_reason = 'weather'
      service1.disruption_date = Time.utc(2015, 04, 03, 04, 20)
      ...
      # expect(db_service_1.updated).to be == time_now
      ...
      expect(db_service_1.disruption_date).to be == Time.utc(2015, 04, 03, 04, 20)
      expect(db_service_1.disruption_details).to be == '<p>weather is pretty bad</p>'
    end

    it "returns all services from database" do
      service1 = Service.new(1, Time.utc(2015, 04, 06, 17, 40), 2, 'Arran', 'Ardrossan - Brodick', 2)
      service1.additional_info = '<p>A1 road closed</p>'
      service1.disruption_reason = 'weather'
      service1.disruption_date = Time.utc(2015, 04, 03, 04, 20)
      service1.disruption_details = '<p>weather is pretty bad</p>'
      ...
      service2 = Service.new(2, Time.utc(2015, 04, 06, 17, 40), 2, 'Arran', 'Ardrossan - Brodick', 2)
      service2.additional_info = '<p>A1 road closed</p>'
      service2.disruption_reason = 'weather'
      service2.disruption_date = Time.utc(2015, 04, 03, 04, 20)
